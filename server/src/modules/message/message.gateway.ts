...
export class MessageGateway implements OnGatewayInit, OnGatewayConnection, OnGatewayDisconnect {
    ...
    async handleSendMessage(client: Socket, @MessageBody() payload: { message: string }): Promise<void> {
        ...
        try {
            ...
            this.server.to(this.teamId.toString()).emit('message', newMessage);
        } catch (error) {
    ...
    async handleDeleteMessage(client: Socket, @MessageBody() payload: { message: string }): Promise<void> {
