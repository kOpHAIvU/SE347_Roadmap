...
function TimelineSetting() {
    ...
    useEffect(() => {
        const fetchUserList = async () => {
            try {
                const response = await fetch(`http://50.112.48.169:3004/group-division/timelineId/${id}`, {
                    method: 'GET',
                    headers: {
    ...
    const handleRevokeInvite = async (inviteId) => {
        ...
        try {
            const response = await fetch(`http://50.112.48.169:3004/group-division/item/${inviteId}`, {
                method: 'DELETE',
                headers: {
                    Authorization: `Bearer ${getToken()}`,
                    'Content-Type': 'application/json',
    ...
    const handleDeleteUser = async (groupId) => {
        ...
        try {
            const response = await fetch(`http://50.112.48.169:3004/group-division/item/${groupId}`, {
                method: 'DELETE',
                headers: {
                    Authorization: `Bearer ${getToken()}`,
                    'Content-Type': 'application/json',
    ...
    const handleDeleteTimeline = async () => {
        ...
        try {
            const response = await fetch(`http://50.112.48.169:3004/timeline/item/${id}`, {
                method: 'DELETE',
                headers: {
                    Authorization: `Bearer ${getToken()}`,
                    'Content-Type': 'application/json',
    ...
    useEffect(() => {
        const fetchProfileAndCheckRole = async () => {
            try {
                // Fetch profile
                const profileResponse = await fetch('http://50.112.48.169:3004/auth/profile', {
                    method: 'GET',
                    headers: {
                        Authorization: `Bearer ${getToken()}`,
                        'Content-Type': 'application/json',
                ...
                if (profileResponse.ok) {
                    ...
                    const groupResponse = await fetch(`http://50.112.48.169:3004/group-division/timelineId/${id}`, {
                        method: 'GET',
                        headers: {
                            Authorization: `Bearer ${getToken()}`,
                            'Content-Type': 'application/json',
    ...
    const performSearch = async (term) => {
        ...
        try {
            ...
            const response = await fetch(`http://50.112.48.169:3004/user/search/${term}`, {
                method: 'GET',
                headers: {
    ...
    const fetchNewNotification = async (timelineName, type) => {
        try {
            ...
            const response = await fetch('http://50.112.48.169:3004/notification/new', {
                method: 'POST',
                headers: {
                    Authorization: `Bearer ${getToken()}`,
    ...
    const handleAddToTimeline = async () => {
        ...
        try {
            ...
            const response = await fetch('http://50.112.48.169:3004/group-division/new', {
                method: 'POST',
                headers: {
                    Authorization: `Bearer ${token}`,
                    'Content-Type': 'application/json',
