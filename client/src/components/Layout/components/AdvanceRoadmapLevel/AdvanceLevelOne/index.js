...
function AdvanceLevelOne({ userType, node, index, onDragMove, updateNodeContent
                ...
                <>
                    ...
                    {(nodeBelowTypes === 'Checkbox' || nodeBelowTypes === null) && (
                        ...
                        <Rect
                            ...
                            onClick={() => handleAddChildLevelNode(index, node.x, node.y, node.level, 'Checkbox')}
                        />
                    )}
                    ...
                    {(nodeBelowTypes === 'RadioButton' || nodeBelowTypes === null) && (
                        ...
                        <Circle
                            ...
                            onClick={() => handleAddChildLevelNode(index, node.x, node.y, node.level, 'RadioButton')}
                        />
                    )}
                </>
            )}
