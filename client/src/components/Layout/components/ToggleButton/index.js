...
function ToggleButton() {
    return (
        ...
        <div className={cx('toggle-cont')}>
            <input className={cx('toggle-input')} id="toggle" name="toggle" type="checkbox" />
            <label className={cx('toggle-label')} htmlFor="toggle">
                <div className="cont-icon">
                    ...
                    <span
                        ...
                        className="sparkle"
                    ></span>
                    {/* Continue updating all `style` attributes in this manner */}
                    <svg
