...
function SearchRoadmap() {
    ...
    const fetchSearchRoadmap = async (profileId) => {
        try {
            const response = await fetch(`http://50.112.48.169:3004/roadmap/search/${search}?page=1&limit=4`, {
                method: 'GET',
                headers: {
    ...
    const fetchSearchTimeline = async (profileId) => {
        try {
            const response = await fetch(`http://50.112.48.169:3004/timeline/search/${search}?page=1&limit=4`, {
                method: 'GET',
                headers: {
                    'Authorization': `Bearer ${getToken()}`,
                    'Content-Type': 'application/x-www-form-urlencoded',
